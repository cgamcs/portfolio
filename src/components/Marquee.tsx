    ...
    <>
      <div className="marquee">
        <ul className="marquee__content">
          ...
          <div className="marquee__item">
            <img src="/postgress_light.png" alt="logo de postgres" className="block dark:hidden" />
            <img src="/postgress_dark.png" alt="logo de postgres" className="hidden dark:block" />
          </div>
          <div className="marquee__item">
