  ...
  return (
    <>
      <main className="mt-10">
        <h2 className="font-medium text-black dark:text-white mb-5 sm:mb-6">Actualmente</h2>
        ...
        <section className="-mb-3 mt-16 sm:mt-16">
          <h2 className="font-medium text-black dark:text-white mb-5 sm:mb-6">Proyectos</h2>
        ...
        <section className="-mb-3 mt-16 sm:mt-32">
          <h2 className="font-medium text-black dark:text-white mb-5 sm:mb-6">Experiencia</h2>
        ...
        <section className="-mb-3 mt-16 sm:mt-32">
          <h2 className="font-medium text-black dark:text-white mb-5 sm:mb-6">Más información</h2>
